...
Pushing a version tag such as `v0.4.27` runs the Windows release workflow. The workflow builds the app and uploads the installer/portable `.exe` files to a draft GitHub Release.
